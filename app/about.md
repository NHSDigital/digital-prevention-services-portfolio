...
We're organised into 5 delivery areas, focused on specific aspects of healthcare: [vaccinations](/vaccinations), [screening](/screening), children's health, home testing and personalised prevention. These areas are supported by two additional support areas: one working on operations, and another on cross-cutting technology, data, innovation and communications.

## How we work

Our teams build services [for the NHS, by the NHS](/docs/for-the-nhs-by-the-nhs).

We are:

- replacing and upgrading old NHS technology with modern alternatives
- putting user needs first, designing and iterating with input from real people who will use what we build
- upholding our values of being considerate, inclusive, bold and open
...
... please send an email to [england.dpsp-front-door@nhs.net](mailto:england.dpsp-front-door@nhs.net)
