...
![Screenshot of the NHS App showing a message from NHS Screening. The message tells a patient that their next bowel cancer screening home test kit should arrive within 2 weeks, and the message asks them to check the address the NHS holds is corrrect.](/assets/images/bowel-screening-summer-2026.png)
